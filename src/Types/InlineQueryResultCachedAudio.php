 ...
 * you can use <em>input_message_content</em> to send a message with the
 * specified content instead of the audio.
 *
 * @version Telegram Bot Casts v2.0.0 (Bot API 7.2)
 * @author Sergey Makhlenko <https://github.com/mahlenko>
 */
final class InlineQueryResultCachedAudio extends TelegramType implements InlineModeInterface
{
