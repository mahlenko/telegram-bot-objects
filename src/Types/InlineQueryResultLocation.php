 ...
 * by the user. Alternatively, you can use <em>input_message_content</em>
 * to send a message with the specified content instead of the location.
 *
 * @version Telegram Bot Casts v2.0.0 (Bot API 7.2)
 * @author Sergey Makhlenko <https://github.com/mahlenko>
 */
final class InlineQueryResultLocation extends TelegramType implements InlineModeInterface
{
