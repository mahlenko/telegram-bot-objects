...
final readonly class Chat implements TelegramTypeInterface
{
    public function __construct(
        ...
        /**
         * For private chats with business accounts, the intro of the business. Returned
         * only in getChat.
         */
        public ?BusinessIntro $business_intro,
        /**
         * For private chats with business accounts, the location of the business. Returned
         * only in getChat.
         */
        ...
        /**
         * Custom emoji identifier of emoji chosen by the chat for the reply header and
         ...
         * each unprivileged user; in seconds. Returned only in getChat.
         */
        public ?int $slow_mode_delay,
        /**
         * For supergroups, the minimum number of boosts that a non-administrator user
         * needs to add in order to ignore slow mode and chat permissions. Returned only in
         * getChat.
         */
        ...
        /**
         * True, if messages from the chat can't be forwarded to other chats. Returned only
         * in getChat.
         */
         ...
         * from this set can be used by all users and bots in the group. Returned only in
         * getChat.
         */
