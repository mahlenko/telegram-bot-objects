...
final readonly class Message implements TelegramTypeInterface
{
    public function __construct(
        ...
        public ?User $from,
        /**
         * Sender of the message, sent on behalf of a chat. For example, the channel itself
         ...
         * discussion group. For backward compatibility, the field from contains a fake
