 ...
 * without sound). On success, the sent <a href="#message">Message</a> is
 * returned. Bots can currently send animation files of up to 50 MB in
 * size, this limit may be changed in the future.
 *
 * @version Telegram Bot Casts v2.0.0 (Bot API 7.2)
 * @author Sergey Makhlenko <https://github.com/mahlenko>
 */
final class SendAnimation extends TelegramMethod implements MethodsInterface
{
    /**
