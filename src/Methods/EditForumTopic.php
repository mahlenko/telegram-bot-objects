 ...
 * and must have <em>can_manage_topics</em> administrator rights, unless
 * it is the creator of the topic. Returns <em>True</em> on success.
 *
 * @version Telegram Bot Casts v2.0.0 (Bot API 7.2)
 * @author Sergey Makhlenko <https://github.com/mahlenko>
 */
final class EditForumTopic extends TelegramMethod implements MethodsInterface
{
    /**
