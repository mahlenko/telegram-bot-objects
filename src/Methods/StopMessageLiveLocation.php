 ...
 * inline message, the edited <a href="#message">Message</a> is returned,
 * otherwise <em>True</em> is returned.
 *
 * @version Telegram Bot Casts v2.0.0 (Bot API 7.2)
 * @author Sergey Makhlenko <https://github.com/mahlenko>
 */
final class StopMessageLiveLocation extends TelegramMethod implements UpdatingMessagesInterface
{
    /**
